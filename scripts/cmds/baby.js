    ...
    if (event.type !== "message_reply" && mahmud.some(word => message.startsWith(word))) {
      ...
      const res = await axios.post(`${await baseApiUrl()}/api/hinata`, { text, style: 3, attachments });  return res.data.message; } catch {  return "error janu🥹";
       ...
       const randomMessage = [
          ...
          "🐒🐒🐒",
          "এত ডাকলে কিন্তু গালি দাব দুষ্টু 🤭😏",
          ...
          "𝗜 𝗵𝗮𝘁𝗲 𝘆𝗼𝘂_2_😏😏",
          "গোসল করে আসো যাও😑😩",
        "অতিরিক্ত সরল হতে যেওনা..!😑এই স্বার্থপর সমাজ তোমাকে ঠকিয়ে দেবে..!🖤🥀",
          "👉.কিছু সম্পর্ক ভাড়া বাড়ির মতো…!!👉.তুমি যতই সাজাও নিজের কখনো হবে না..✖✖",
          "আপনি যে নাম্বারে কল করেছেন,
সেটি এখন অন্য কলে ব্যস্ত আছে!
অনুগ্রহ করে সন্দেহ করুন!",
          ...
          "𝐈𝐧𝐛𝐨𝐱 এ নক দিলে 𝟏𝟎𝐆𝐁 এমবি ফ্রী 🫢*অফার শুধু মেয়েদের জন্য..!🤭",
          "আমাকে ডেকো না,আমি ব্যাস্ত আসি🙆🏻‍♀",
          "𝗕𝗯𝘆 বললে চাকরি থাকবে না",
          "𝗕𝗯𝘆 𝗕𝗯𝘆 না করে আমার বস মানে, অনিক ,অনিক ও তো করতে পারো😑?",
          ...
          "তুমি ফুল আমি কলি WhatsApp আসো।🙈🙈❤️🤍💬🤍❤️মনের কথা খুলে বলি/__👻🤷👈 💛🚖",
          ...
          "ওই তুমি single না?🫵🤨 😑😒",
          "^°~` তুই আজকে গোসল করোস নাই তাই না..!🐸🥲🥴<[ ]>_/ \",
          "– প্রেম’🙂– সেটা তো আমার বন্ধু-বান্ধবীরা করে.!🙄– আমি তো শুধু হিসেব রাখি কে কয়টা করলো.!😎",     
          ...
          "-ছোট বেলায় একটু সাবান খাইছিলাম🧼🤌তখন থেকেই মনটা পরিষ্কার,," 
        ];
...
"আমি তোমার সাথে প্রেম করবো 🤭"
"○ প্যারা নাই চিল 🤟~ আই লাভ ইউ না কইলে ~ধইরা দিমু কিল 👿😁||~○⊕,,,,,,ল"
"—!বিশ্বাস”আর”ভালোবাসা”ঠিক”থাকলে-🙂🌺🖤—!🌻𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 Messenger এর রিলেশন’শিপও পূর্ণতা’পায়😇🦋🥀❤️🖤🤍"
"এই’নেও🔑চাবী 😒𝘪𝘯𝘣𝘰𝘹-এর 🔐তালা”খুলে”মেছেজ”দেও📥🫠🤗 I am single🔪😒"
"বয়সটা প্রেম করার,,😇🥀"
"এতো ঢং বাদ দিয়েEgo-বাদ দিয়ে ogo বলে ডাকো😁আমি Kigo বলে সাড়া দিবো🤗"
